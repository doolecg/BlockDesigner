...
final class ShortcutsPanel extends VBox {
    static final String[][][] SECTIONS = {
            {{"Modes"},
                    ...
                    {"{TOOL_MOVE} / {TOOL_ROTATE}", "Move / Rotate tool (gizmos for the selected layers)"},
            ...
            {{"Select mode"},
                    ...
                    {"{TOOL_MOVE} / {TOOL_ROTATE}", "With blocks selected: move / rotate just those blocks within their layer"},
