...
final class ShortcutsPanel extends VBox {
    private static final String[][][] SECTIONS = {
            ...
            {{"Select mode"},
                    ...
                    {"Shift+right-click", "Menu: region fill, delete, replace, select by type, copy to layer, hide, lock"},
            ...
            {{"WorldEdit (press /)"},
                    ...
                    {"//copy · //cut · //paste", "Clipboard (relative to pos1; -a skips air)"},
                    ...
                    {"//undo · //redo · //help", "Also Tab completes, ↑ ↓ history"}},
            {{"Move & Rotate tools"},
